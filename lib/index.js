...
Launch.command("test", "test the thing").action(function (args) {
  console.log(_util2.default.hasPlatform("ios"));
});

Launch.command("init", "Generates launch.json file for environment vars").action(function (args) {
...
Launch.command("import", "Import certificates").action(function (args) {
  _util2.default.importCerts(superEnv).catch(function (error) {
    return console.log(error);
  });
});

Launch.command("build", "Builds the Meteor app in the .build folder").action(function (args) {
  _meteor2.default.build(superEnv).catch(function (error) {
    return console.log(error);
  });
});

Launch.command("hockey", "Build and deploy to Hockey").action(function (args) {
...
Launch.command("testflight", "Build and deploy to TestFlight").action(function (args) {
  _util2.default.addFastfile().then(function () {
...
Launch.command("appstore", "Build and deploy to iTunes App Store").action(function (args) {
  _util2.default.addFastfile().then(function () {
...
Launch.command("playstore", "Build and deploy to Google Play Store").action(function (args) {
...
Launch.command("production", "Build and deploy to iTunes and Play").action(function (args) {
  _util2.default.addFastfile().then(function () {
    return _android2.default.prepareApk(superEnv);
  }).then(function () {
    return _play2.default.uploadPlayStore(superEnv);
